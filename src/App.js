...
class App extends Component {
  ...
  this.setState((prevState)=>{
    ...
    {
        this.setState({
          movie:this.state.movie.filter((el,index)=>
        {
            return index!==i
        }),
    ...
    {
      this.setState({
        movie:this.state.movie.concat(x),
  ...
  render() {
    ...
    return (
      ...
      <div style={{height:'100%'}}>
        ...
        <MovieList movielist={this.state.filtred} delay={this.state.delay} remove={(i)=>this.remove(i)} add={(i)=>this.addFilm(i)}/>
